 ...
 * </ul>
 *
 * Modified by Contao Community Alliance to:
 * <ul>
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class ContaoCommunityAlliance_Sniffs_Commenting_FunctionCommentSniff extends Squiz_Sniffs_Commenting_FunctionCommentSniff
{
            ...
            if ($return !== null) {
                ...
                if (empty($content) === true) {
                    ...
                    foreach ($typeNames as $typeName) {
                        $suggestedName = $this->translateSuggestedType($typeName, $suggestedNames);
    ...
    protected function processParams($commentStart, $commentEnd)
    {
        ...
        if (empty($params) === false) {
            ...
            foreach ($params as $param) {
                ...
                foreach ($typeNames as $typeName) {
                    $suggestedName = $this->translateSuggestedType($typeName);
                ...
                if (isset($realParams[($pos - 1)]) === true) {
                    ...
                    //
                    // Here CCA removed the prepending of ampersand to the variable name as this breaks phpDocumentor.
                    //
