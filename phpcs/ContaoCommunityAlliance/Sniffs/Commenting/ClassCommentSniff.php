<?php
/**
 * ContaoCommunityAlliance_Sniffs_Commenting_ClassCommentSniff.
 *
 * PHP version 5
 * TYPO3 version 4
 *
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class ContaoCommunityAlliance_Sniffs_Commenting_ClassCommentSniff extends PEAR_Sniffs_Commenting_ClassCommentSniff {
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr) {
        ...
        if (strtolower($testShort) == '{@inheritdoc}') {
            return;
        }
